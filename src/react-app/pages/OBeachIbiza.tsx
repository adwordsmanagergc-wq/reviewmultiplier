...
const STORAGE_KEY = 'obeach_ibiza_prize'
...
const BG_IMAGE = 'https://019d4ea7-203f-7f51-8c55-110f9f85cb54.mochausercontent.com/openart-image_1775225213281_390202af_1775225213323_fb8285d5.png'
...
export default function OBeachIbiza() {
        ...
        {showForm && winner && (
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-5 shadow-xl w-full max-w-sm mb-4">
            <div className="text-center mb-4">
              ...
              <p className="text-gray-600 text-sm">Enter your details to be put on the guest list for Grand Opening Party 1st May and claim your prize</p>
            </div>
